...
void Rspawn(float fX, float fY, float fZ)
{
	...
	if (vAlias == "footsw"){ // If Garcia is spawned, his alias will be adjusted to his remap
	  if (iMap == 1){
          vAlias = "Joseph";
        } else if (iMap == 2){
          vAlias = "Brash";
      ...
      } else if (vAlias == "footaxe"){ // If Ray is spawned, his alias will be adjusted to his remap
        if (iMap == 1 || iMap == 4){
          vAlias = "J";
      ...
      } else if (vAlias == "footn"){ // If Lesus is spawned, his alias will be adjusted to his remap
	  if (iMap == 1){
          vAlias = "Frost";
        } else if (iMap == 2){
          vAlias = "Hail";
